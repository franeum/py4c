...
int main(int argc, char* argv[])
{
    ...
    Py_SetPath(Py_DecodeLocale(
        "/usr/local/lib/python38.zip:/usr/local/lib/python3.8:/usr/local/lib/python3.8/lib-dynload:/usr/local/lib/python3.8/site-packages", NULL));
    //"/usr/local/lib/python39.zip:/usr/local/lib/python3.10:/usr/local/lib/python3.10/lib-dynload:/home/neum/Documenti/py4c/venv39/lib/python3.10/site-packages", NULL));
    /*
    if (program == NULL) {
    ...
    */
    ...
    printf("version: %s\n", Py_GetVersion());
    */
    // Py_SetProgramName(Py_DecodeLocale("python3.10", NULL));
    //  printf("PATH: %s", Py_EncodeLocale(Py_GetPath(), NULL));
